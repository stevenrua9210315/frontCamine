...
export default function Home() {
  ...
  // Handlers
  const handleSignup = () => login({ authorizationParams: { screen_hint: "signup" } });
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 font-sans">
        ...
        {isAuthenticated ? (
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-full text-left bg-gray-900 rounded-lg p-4 mb-6 overflow-x-auto">
              <p className="text-xs font-mono text-blue-400 mb-2 uppercase tracking-widest">User Raw Data</p>
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Mi Aplicación</h1>
            <p className="text-gray-500 mb-8">Inicia sesión para acceder a tu perfil</p>
      ...
      <p className="mt-8 text-gray-400 text-xs uppercase tracking-widest">Powered by Auth0 & Gemini</p>
    </div>
  );
}